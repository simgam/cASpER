...
public class SQLFeatureSelection implements SQLiteCriterion {
    ...
    public String toSQLquery() {
        return "SELECT MethodBean.fullQualifiedName AS MfullQualifiedName, Metodo_SmellType.methodBeanFullQualifiedName, Metodo_SmellType.codeSmellFullQualifiedName, belongingClass, fqn_envied_class, ClassBean.textContent AS CtextContent, MethodBean.textContent AS MtextContent," +
