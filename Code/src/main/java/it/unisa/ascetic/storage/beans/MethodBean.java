...
public class MethodBean implements Comparable {
    ...
    /**
     * aggiunge un parametro al metodo
     *
     * @param key  nome del parametro
     * @param bean tipo del parametro
     */
    public void addParameters(String key, ClassBean bean) {
        if (parameters != null) parameters.put(key, bean);
    }

    /**
     * rimuove un parametro dal metodo
     *
     * @param key nome del parametro
     */
    ...
    /**
     * aggiunge un metodo alla lista di metodi chiamati
     *
     * @param bean metodo da aggiungere
     */
    public void addMethodsCalls(MethodBean bean) {
        if (methodsCalls != null && methodsCalls.getList() != null)
            methodsCalls.getList().add(bean);
    }

    /**
     * rimuove un metodo dalla lista di metodi chiamati
     *
     * @param bean
     */
    public void removeMethodsCalls(MethodBean bean) {
        if (methodsCalls != null && methodsCalls.getList() != null)
            methodsCalls.getList().remove(bean);
    }
    ...
    /**
     * rimuove uno smell dalla lista degli smell dai quali è affetto il metodo
     *
