...
public class PromiscuousPackagePage extends DialogWrapper {
    ...
    public PromiscuousPackagePage(PackageBean packageBeanPP) {
        super(true);
        this.packageBeanPP = packageBeanPP;
        init();
        setTitle("ANALYSIS CODE SMELL PROMISCUOUS PACKAGE");
    }
    ...
    protected JComponent createCenterPanel() {
        ...
        panelRadarMap = radarMapUtils.createRadarMapFromPackageBean(packageBeanPP, "PROMISCUOUS PACKAGE");
        ...
        Object[] label = {"NOC", "MIC"};
        Object[] contenuto = {CKMetrics.getNumberOfClasses(packageBeanPP), CKMetrics.computeMediumIntraConnectivity(packageBeanPP)};
       ...
       // panelEast.add(scrollPaneArea);
        ...
        class RefactorListener implements ActionListener {  //Listener per il button refactor
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                //RefactorPPDialog refactorDialog = new RefactorPPDialog();
                //refactorDialog.show();
            }
        }
