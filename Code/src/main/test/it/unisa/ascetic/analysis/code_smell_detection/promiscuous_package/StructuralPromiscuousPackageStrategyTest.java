...
public class StructuralPromiscuousPackageStrategyTest {
    ...
    public void isSmellyTrue() {
        ...
        StructuralPromiscuousPackageStrategy analisi = new StructuralPromiscuousPackageStrategy(systemPackage, 0,0); // SOGLIE DI PROVA
        ...
        HashMap<String, Double> p = analisi.getThresold(smelly);
