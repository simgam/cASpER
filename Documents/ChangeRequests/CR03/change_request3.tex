...
\begin{document}
	...
	\begin{table}[h!]
		...
		\begin{tabularx}{0.9\textwidth}{|p{3cm}|p{2cm}|X|l|}
			...
			CR-03 & 10/10/2018 & Manuel De Stefano & \textbf{Alta} \\ \hline
		\end{tabularx}
	\end{table}
	...
	\section{Descrizione}
		Si richiede la modifica delle interfacce di alcuni sottosistemi, in particolare il sottosistema \textit{codeSmellDetection}, il sottosistema \textit{parser} e il sottosistema \textit{refactoring}, applicando design pattern specifici. 
		Per ulteriori dettagli si rimanda al documento di change impact analysis e al documento di object design.
	\section{Scopo}
		Lo scopo è quello di applicare design patterns, come lo \textit{Strategy Pattern}, a vari sottosistemi, modificandone meno possiblile le interfacce, con il fine di favorire il riuso del codice e di migliorare la manutenibilità.
		
	\section{Conseguenze se non accettata}
		Tale modifica non va ad impattare le funzionalità del software. Tuttavia, questa manutenzione adattiva è necessaria per favorire le evoluzioni successive.
